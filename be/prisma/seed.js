...
async function main() {
	...
	const prestasiData = [
		{
			...
			deskripsi:
				"Diraih oleh siswa kelas VIII pada kompetisi tingkat kota yang diselenggarakan oleh Dinas Pendidikan.",
			tahun: "2024",
		},
		{
		...
		},
		{
			...
			deskripsi:
				"Prestasi membanggakan dari siswa kelas IX yang mengikuti olimpiade matematika tingkat kabupaten.",
			tahun: "2023",
		},
		{
			judul: "Juara 3 Lomba Karya Ilmiah Remaja",
			deskripsi:
				"Prestasi di bidang sains yang diraih oleh tim siswa SMP Katolik St. Rafael pada ajang Lomba KIR Provinsi.",
			tahun: "2023",
		},
	];
	...
	const ekstrakurikulerData = [
		...
		},
		{
			...
			deskripsi:
				"Ekstrakurikuler seni budaya yang membina siswa dalam melestarikan tarian daerah Kalimantan dan Nusantara.",
	...
	console.log(`  Admin        → username: admin       | password: ${hashedAdminPass}`);
	console.log(`  Verifikator  → username: verifikator | password: ${hashedVerifPass}`);
	console.log("──────────────────────────────");
}
