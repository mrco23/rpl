...
export const createProfil = async (req, res) => {
  try {
    ...
    return res.status(201).json({ message: "Profil berhasil dibuat", data: ProfilService.serialize(req, updatedData) });
  } catch (error) {
    if (error.code === "P2002") {
...
export const updateProfilData = async (req, res) => {
  try {
    ...
    const updatedData = await ProfilService.getProfilPlain(idAdmin);
    return res.status(200).json({ message: "Data profil berhasil diperbarui", data: ProfilService.serialize(req, updatedData) });
  } catch (error) {
...
export const updateProfilImage = async (req, res) => {
  try {
    ...
    const updatedData = await ProfilService.getProfilPlain(idAdmin);
    return res.status(200).json({ message: "Gambar profil berhasil diperbarui", data: ProfilService.serialize(req, updatedData) });
  } catch (error) {
...
export const upsertKontak = async (req, res) => {
  try {
    ...
    const updatedData = await ProfilService.getProfilPlain(idAdmin);
    return res.status(200).json({ message: "Kontak berhasil diperbarui", data: ProfilService.serialize(req, updatedData) });
  } catch (error) {
