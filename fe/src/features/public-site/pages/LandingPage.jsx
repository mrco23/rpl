            ...
            {loading ? (
                ...
                <section className="relative w-full h-[50vh] flex items-center justify-center bg-gray-50 rounded-b-3xl">
                    <p className="text-gray-500 font-medium">
                        Data Landing Page tidak tersedia.
                    </p>
                </section>
            ) : (
                <section className="relative w-full min-h-[50vh] sm:min-h-[60vh] md:min-h-[63vh] xl:min-h-[67vh] flex items-stretch">
                    <div
                    ...
                    <div className="relative z-10 w-full max-w-7xl m-auto px-6 sm:px-10 flex flex-col justify-start text-white">
                        <div className="w-full text-left flex flex-col gap-0 md:gap-5">
                            ...
                            <p className="text-sm md:text-base mb-8 max-w-4xl opacity-90 leading-relaxed">
                                Mulai perjalanan pendidikan menengah Anda di SMP Katolik
                                St. Rafael Manado. Kami menyediakan lingkungan belajar
                                yang mendukung prestasi dan pertumbuhan karakter. Klik
                                tombol di bawah untuk proses pendaftaran.
                            </p>
