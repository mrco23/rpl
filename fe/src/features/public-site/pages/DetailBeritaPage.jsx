  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        console.error("[DetailBeritaPage] Gagal mengambil detail berita:", error);
      ...
      <section className="w-full py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6">
          ...
          {displayImage ? (
            ...
            <div className="w-full h-96 bg-slate-200 flex items-center justify-center rounded-xl mb-6 text-slate-500">
