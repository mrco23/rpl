...
export default function KontakSekolahCard({ loading, profile, onOpenKontak }) {
  return (
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Instagram{" "}
              <span className="text-[10px] bg-blue-100 text-blue-600 px-1.5 py-0.5 rounded ml-1">LINK</span>
            </label>
            <input
              readOnly
