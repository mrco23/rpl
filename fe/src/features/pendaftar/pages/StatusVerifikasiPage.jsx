...
const STATUS_META = {
  "menunggu verifikasi": {
    ...
    description: "Dokumen sudah masuk ke sistem dan sedang menunggu pemeriksaan dari panitia.",
    iconBgClass: "bg-yellow-light text-yellow-900 border border-yellow-normal/30",
    textClass: "text-yellow-900",
  },
  "perlu perbaikan": {
    label: "PERLU PERBAIKAN",
    description: "Ada dokumen atau data yang perlu diperbaiki. Silakan cek catatan dari panitia.",
    iconBgClass: "bg-yellow-light text-yellow-900 border border-yellow-normal/30",
    textClass: "text-yellow-900",
  },
  "unggah ulang": {
      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div className="bg-white rounded-3xl p-6 md:p-8 shadow-card border border-gray-100 max-w-4xl">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6 pb-6 border-b border-gray-100">
            <div className={`p-4 rounded-2xl flex-shrink-0 ${statusMeta.iconBgClass}`}>
            ...
            <div>
              ...
              <h2 className={`text-2xl md:text-3xl font-bold uppercase ${statusMeta.textClass}`}>
                {statusMeta.label}
              </h2>
            ...
            <div className="bg-[#f5f6f8] rounded-2xl p-5 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm md:text-base font-semibold text-gray-900 mt-1">
                  {statusData?.tanggal_daftar ? formatMediumDate(statusData.tanggal_daftar) : "-"}
                </p>
              </div>
            </div>
            <div className="bg-[#f5f6f8] rounded-2xl p-5 flex items-start gap-4">
          ...
          <div className="mt-8 pt-8 border-t border-gray-100 relative">
            ...
            <div className="flex justify-between relative z-10 px-2 md:px-6">
              {STEPS.map((step, index) => {
                ...
                return (
                  <div key={step.key} className="flex flex-col items-center max-w-[100px] md:max-w-[150px]">
                    <div
                    ...
                    >
                      {isDone ? <FaCheckCircle className="text-xl" /> : <Icon className="text-xl" />}
                    </div>
