                ...
                {gelombangLoading ? (
                    ...
                    <div className="bg-white rounded-xl border border-red-200 shadow-sm p-10 text-center">
                        ...
                        <p className="text-gray-500 mb-8 max-w-md mx-auto">
                            Mohon maaf, saat ini tidak ada gelombang pendaftaran (PPDB)
                            yang sedang aktif. Silakan pantau informasi terbaru di halaman
                            beranda atau hubungi pihak sekolah.
                        </p>
                        <button
                            onClick={() => navigate("/")}
                    ...
                    <>
                        ...
                        <div className="bg-yellow-100 p-4 rounded-lg mb-6 items-start gap-3">
                            ...
                            <ul className="list-disc ml-2 text-slate-700 px-5">
                                <li>
                                    Isi data diri calon siswa secara benar dan sesuai
                                    dokumen resmi (KK/Ijazah).
                                </li>
                                <li>Pastikan nomor HP aktif dan dapat dihubungi.</li>
                                <li>
                                    Simpan NISN dan password baik-baik karena akan
                                    digunakan untuk login selama proses PPDB berlangsung.
                                </li>
                            </ul>
                        </div>
                            ...
                            >
                                ...
                                <div className="border-b pb-4 mb-4">
                                    ...
                                    <p className="text-sm font-medium text-blue-700 mt-2">
                                        Kata sandi minimal 6 karakter, harus mengandung
