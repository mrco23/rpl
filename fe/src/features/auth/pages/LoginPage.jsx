  ...
  return (
    <div className="flex justify-center items-center h-screen">
      ...
      <div className="flex w-full lg:w-1/2 items-start justify-center px-4 lg:px-14 pt-8">
        ...
        >
          <h2 className="text-3xl text-center font-bold mb-4">Masuk Pendaftar</h2>
          <p className="text-center text-gray-500 mb-8 text-sm">Gunakan NISN SD dan kata sandi untuk masuk ke akun pendaftar.</p>
