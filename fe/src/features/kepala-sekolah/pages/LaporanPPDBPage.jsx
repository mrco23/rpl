...
export default function LaporanPPDBPage() {
  ...
  const laporans = [
    { id: "rekap-ppdb", title: "Laporan Rekapitulasi PPDB", desc: "Ringkasan seluruh pendaftar, status seleksi, dan data utama PPDB." },
    { id: "final-penerimaan", title: "Laporan Final Penerimaan", desc: "Daftar pendaftar yang dinyatakan lulus sebagai bahan pengesahan kepala sekolah." },
  ];
