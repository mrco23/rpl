...
export default function LaporanPPDBPage() {
    ...
    const handleDownload = async (id, format) => {
        ...
        setToast({
            show: true,
            message: `Mengunduh laporan ${format.toUpperCase()}...`,
            type: "info",
        });
        try {
        ...
        <div className="max-w-7xl mx-auto pb-10 space-y-6">
            ...
            <div className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100">
                ...
                <p className="text-gray-500 text-sm leading-relaxed max-w-2xl">
                    Unduh laporan resmi PPDB. PDF digunakan sebagai laporan dengan kop
                    surat, sedangkan Excel untuk rekap data yang dapat diolah kembali.
                </p>
            </div>
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex items-start justify-between gap-3">
                                ...
                                <span
                                    className={`text-[10px] font-bold uppercase tracking-wide px-2.5 py-1 rounded-full border ${lap.badgeClass}`}
                                >
                                    {lap.badgeLabel}
                                </span>
                            </div>
