...
import SidebarKepalaSekolah from "../components/SidebarKepalaSekolah";
import { Outlet } from "react-router-dom";
import { Menu, X } from "lucide-react";

function KepalaSekolahLayout() {
  ...
  return (
    <div className="flex h-screen overflow-hidden relative">
      ...
      `}>
          <SidebarKepalaSekolah onClose={() => setIsSidebarOpen(false)} />
      </div>
...
export default KepalaSekolahLayout;
