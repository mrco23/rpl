...
export default function AdminProfilSekolahPage() {
          ...
          >
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setCreateData({ ...createData, nama_sekolah: e.target.value })
                }
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setCreateData({ ...createData, visi: e.target.value })
                }
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setCreateData({ ...createData, misi: e.target.value })
                }
                className="w-full border border-gray-300 rounded-md px-3 py-2 resize-none"
              />
            </div>
            ...
            <div className="flex items-center justify-center w-full gap-5">
              <div className="w-1/4">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setCreateData({ ...createData, akreditasi: e.target.value })
                  }
              ...
              <div className="w-3/4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setCreateData({ ...createData, nomor_sk_akreditasi: e.target.value })
                  }
  ...
  return (
    <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="flex">
                    ...
                    {loading ? (
                      <Skeleton className="h-10 flex-1 rounded-none rounded-r-md" />
                    ) : (
                      <input
                        type="text"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-md px-3 py-1 text-xs bg-gray-50 outline-none"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
        ...
        <form onSubmit={handleUpdateInfo} className="space-y-4">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setInfoData({ ...infoData, nama_sekolah: e.target.value })
              }
          ...
          <div>
            ...
            <textarea
              ...
              value={infoData.visi}
              onChange={(e) =>
                setInfoData({ ...infoData, visi: e.target.value })
              }
              className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm"
            />
          </div>
          <div>
            ...
            <textarea
              ...
              value={infoData.misi}
              onChange={(e) =>
                setInfoData({ ...infoData, misi: e.target.value })
              }
              className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm"
            />
          </div>
      ...
      <Modal
        open={isKepsekModalOpen}
        onClose={() => setIsKepsekModalOpen(false)}
        ...
        <form onSubmit={handleUpdateKepsek} className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) =>
                setKepsekData({ ...kepsekData, kata_sambutan: e.target.value })
              }
              className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm"
            />
          </div>
      ...
      {/* MODAL: Edit Kontak */}
      <Modal
        open={isKontakModalOpen}
        onClose={() => setIsKontakModalOpen(false)}
        title="Ubah Kontak Web Sekolah"
      >
        <form
        ...
        >
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setKontakData({ ...kontakData, no_telpon: e.target.value })
                }
                className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setKontakData({ ...kontakData, whatsapp: e.target.value })
                }
                className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setKontakData({ ...kontakData, email: e.target.value })
              }
              className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm"
            />
          </div>
          ...
          <div className="pt-4 flex justify-end gap-3 ">
            <button
              type="button"
              onClick={() => setIsKontakModalOpen(false)}
              className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 cursor-pointer"
            >
              Batal
            </button>
