  ...
  return (
    <>
      ...
      <section className="text-center max-w-7xl mx-auto px-6 mb-12 mt-14">
        <p className="text-gray-900 text-lg sm:text-3xl leading-relaxed font-semibold mb-10 lg:mb-5">
      ...
      <br />
      <div className="block border-b-2 border-gray-400 my-2 mx-auto w-full "></div>{" "}
          ...
          {data.map((item, index) => {
            ...
            if (styleIdx === 0) {
              return (
                <div key={index} className="relative mb-24">
                  ...
                  {/* Gambar kanan */}
                  <div className="flex justify-end">
                    <img src={item.gambar_pu || null} alt={item.nama_pu} className="w-64 translate-y-30 object-cover" />
                  </div>
                </div>
              );
            }
            ...
            if (styleIdx === 1) {
              return (
                <div key={index} className="relative mb-24 ">
                  ...
                  {/* Gambar kanan */}
                  <div className="flex justify-start">
                    <img src={item.gambar_pu || null} alt={item.nama_pu} className="w-64 translate-y-80 object-cover" />
                  </div>
                </div>
              );
            }
            ...
            return (
              <div key={index} className="relative min-h-[800px] mb-24 ">
                ...
                {/* Gambar kanan */}
                <div className="flex justify-end">
                  <img src={item.gambar_pu || null} alt={item.nama_pu} className="w-64 translate-y-96 object-cover" />
                </div>
              </div>
            );
          })}
