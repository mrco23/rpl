        ...
        <div className="space-y-7">
          {loading ? (
            Array.from({ length: 3 }).map((_, i) => (
              <div
                key={i}
                className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 italic text-gray-300"
              >
            ...
            dataPengumuman.map((item) => {
              ...
              return (
                <div
                  ...
                  className="bg-blue-50 rounded-xl shadow-lg overflow-hidden border border-blue-100"
                >
                  {/* HEADER */}
                  <button
                  ...
                  >
                    ...
                    <div
                      className={`p-2 rounded-full bg-white/50 transition-transform ${isOpen ? "rotate-180" : ""}`}
                    >
