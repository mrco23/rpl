...
export default function AdminNewsPage() {
  return (
    <DashboardLayout role="Admin" title="Content Management Berita" subtitle="Kelola konten berita agar website publik tetap aktif dan relevan." sidebarItems={adminSidebar}>
      <div className="grid xl:grid-cols-[1.1fr_.9fr] gap-8">
        ...
        <div className="bg-white rounded-[28px] p-8 shadow-[0_20px_45px_var(--color-blue-normal)_/12%] border border-slate-100">
          ...
          <form className="grid gap-5">
            <input className="w-full px-5 py-4 rounded-2xl border border-slate-200" placeholder="Judul berita" />
            <textarea rows="3" className="w-full px-5 py-4 rounded-2xl border border-slate-200" placeholder="Deskripsi singkat" />
            <textarea rows="4" className="w-full px-5 py-4 rounded-2xl border border-slate-200" placeholder="Isi berita" />
