      ...
      <main className="min-h-screen grid lg:grid-cols-2">
        ...
        >
          ...
          <div className="relative text-white p-14 flex flex-col justify-between">
            <div>
              <div className="inline-flex px-4 py-2 rounded-full bg-white/15 border border-white/20 mb-6">
                Portal PPDB Digital
              </div>
              <h2 className="text-5xl font-extrabold leading-tight mb-5">
                Satu Platform untuk Seluruh Proses Pendaftaran
              </h2>
              <p className="text-blue-light text-lg leading-8 max-w-xl">
                Dirancang agar admin, verifikator, dan orang tua siswa bekerja
                lebih cepat dengan alur yang jauh lebih tertata.
              </p>
            </div>
