    ...
    <footer className="bg-blue-200 text-black pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-6 md:px-16">
        ...
        <div className="grid md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-2">
              <a href={profile?.instagram || "#"} target="_blank" rel="noreferrer" className="hover:opacity-80">
                <FaInstagram size={20} className="text-pink-500" />
              </a>
              <a href={profile?.facebook || "#"} target="_blank" rel="noreferrer" className="hover:opacity-80">
                <FaFacebook size={20} className="text-blue-700" />
              </a>
              <a href={profile?.youtube || "#"} target="_blank" rel="noreferrer" className="hover:opacity-80">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              {["Beranda", "Tentang", "Prestasi", "Berita"].map((item) => (
        ...
        <div className="border-t border-gray-400 pt-6 text-center text-sm text-gray-600">
          © {new Date().getFullYear()} {profile?.nama_sekolah || "Website Sekolah"}. All rights reserved.
        </div>
      </div>
    </footer>
  );
